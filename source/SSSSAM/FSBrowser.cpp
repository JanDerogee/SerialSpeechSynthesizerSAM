/* *************************************************************
   * source: Arduino IDE, examples: ESP8266WebServer/FSBrowser *
   *************************************************************
...
//  }
  ...
  server.on("/edit",  HTTP_POST, replyOK, handleFileUpload);  /*Upload file: - first callback is called after the request has ended with all parsed arguments, - second callback handles file upload at that location*/
  server.onNotFound(handleNotFound);                          /*Default handler for all URIs not defined above. Use it to read files from filesystem*/
